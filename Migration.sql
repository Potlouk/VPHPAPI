...
INSERT INTO `Uzivatele` (`id`, `jmeno`, `heslo`, `Studenti_Id`, `Ucitele_Id`) VALUES
(1, 'admin', '$2y$10$wk2TTP3R8NSa33fE52p3L.zBjsRlkMvVLb2e/MigQ4U5ndGvMbKEK', NULL, NULL);
...
ALTER TABLE `Ucitele`
  ADD CONSTRAINT `Ucitele_ibfk_1` FOREIGN KEY (`trida_Id`) REFERENCES `Tridy` (`id`) ON DELETE SET NULL;
